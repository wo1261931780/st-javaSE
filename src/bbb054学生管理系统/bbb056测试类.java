...
//        System.out.println("第一遍循环----------------------");
    ...
    public static void db(ArrayList<bbb055类> student) {
        ...
        for (int q2 = 0; q2 < student.size(); q2++) {
            bbb055类 q3 = student.get(q2);//官方给出的方法是，先设定一个新的变量，然后对新变量直接复写旧变量。
...
//                return;
    ...
    //添加对象
    public static void tj(ArrayList<bbb055类> student) {//录入的数据是给成员变量，学生这个对象以后保存到集合里面去
        ...
        bbb055类 da = new bbb055类(xh, xm, nl, dz);//在类中创建具体的对象/学生
...
//                bbb055类 q3 = new bbb055类(xgxh, xm, nl, dz);//在类中创建具体的对象/学生
                student.set(q2, q3);//把上面的具体对象添加到集合中
                return;
            } else {
    ...
    public static void ck(ArrayList<bbb055类> student) {
        if (student.size() == 0) {
            ...
            System.out.println("学号\t姓名\t年龄\t居住地");//tab键的快速表示
//        System.out.print("学号");
//        System.out.print("          ");
//        System.out.print("姓名");
//        System.out.print("          ");
