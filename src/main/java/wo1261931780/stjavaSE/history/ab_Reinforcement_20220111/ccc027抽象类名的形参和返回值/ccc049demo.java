...
public class ccc049demo {
	public static void main(String[] args) {
		// 创建操作类对象，调用方法
		ccc048动物操作类 xx = new ccc048动物操作类();
		// 因为操作类中的use方法是带参的，参数必须是animal类中的对象
		ccc046animal x = new ccc047子类();
		...
		// 所以必须用子类，通过多态的方式创建，
		// ccc046animal x=new ccc031子类();这里相当于在子类中创建了一个对象x，
		// 而x具备animal这个抽象类的属性
		// 这时把子类对象x传递回use方法中，
