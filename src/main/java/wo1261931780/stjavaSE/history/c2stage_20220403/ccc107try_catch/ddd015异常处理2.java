package wo1261931780.stjavaSE.history.c2stage_20220403.ccc107try_catch;
/*
...
public class ddd015异常处理2 {
    ...
    public static void method() {
        try {
            ...
            // 3.语句输出：
            // java.lang.ArrayIndexOutOfBoundsException: Index 3 out of bounds for length 3
            // at c2stage_20220403.ddd013异常处理.ddd014异常处理2.method(ddd014异常处理2.java:20)
            // at c2stage_20220403.ddd013异常处理.ddd014异常处理2.main(ddd014异常处理2.java:13)
            // ----------------------------------------------
            // 需要注意的是：
