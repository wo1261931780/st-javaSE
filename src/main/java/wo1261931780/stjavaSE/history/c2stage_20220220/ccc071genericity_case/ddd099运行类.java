package wo1261931780.stjavaSE.history.c2stage_20220220.ccc071genericity_case;
...
public class ddd099运行类 {
	public static void main(String[] args) {
		...
		xx.setT("a");
		log.info((String) xx.getT());
		ddd100泛型测试<Object> xx1 = new ddd100泛型测试<>();
		xx1.setT(11);
		log.info((String) xx1.getT());
		log.info("结束--------------------");
	}
}
