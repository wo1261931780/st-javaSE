...
public class ddd026demo {
	public static void main(String[] args) {
		...
		// xx.show();
		ddd024Member_Internal_Classes.ceshi1 x1 = new ddd024Member_Internal_Classes().new ceshi1();
		x1.show();
		System.out.println("--------------------------------------");

		ddd024Member_Internal_Classes x = new ddd024Member_Internal_Classes();
		x.find();
