...
public class ddd036object {
	...
	public ddd036object(int age, String name) {
		this.age = age;
		this.name = name;
	}
    ...
    */
	...
	//     // if (obj instanceof ddd036object) {
	//     //     ddd036object x = (ddd036object) obj;//执行一次强转操作，
	...
	//     // 上面的代码不好
	//     if (obj instanceof ddd036object) {
	//         return this.name.equals(((ddd036object) obj).name) && this.age == ((ddd036object) obj).age ? true : false;
	//     }
	//     return false;
	// }
	...
	public boolean equals(Object o) {// 首先判断是否同个对象(地址相同)
		...
		if (!(o instanceof ddd036object)) {// 对象是否属于xx类
			// 这里也可以使用getclass的方法去获取对象类
			return false;
		}
		ddd036object that = (ddd036object) o;
