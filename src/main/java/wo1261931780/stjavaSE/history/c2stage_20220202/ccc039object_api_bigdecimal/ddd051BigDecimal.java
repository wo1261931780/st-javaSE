package wo1261931780.stjavaSE.history.c2stage_20220202.ccc039object_api_bigdecimal;
...
public class ddd051BigDecimal {
	public static void main(String[] args) {
		...
		log.info(String.valueOf(a3));// 这里20/3=6.67，相当于四舍五入
	}
}
