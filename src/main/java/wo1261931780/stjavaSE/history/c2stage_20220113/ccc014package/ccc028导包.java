package wo1261931780.stjavaSE.history.c2stage_20220113.ccc014package;

// 一般创建对象操作，在同一个包下，可以直接new出来
// 但是对其它的包进行对象创建，就存在导包的操作
// 上面的导包操作直接进入dog内进行导入。

public class ccc028导包 {
	/**
	 * 在不同的包下面进行导包操作，直接把包导入文件
	 */
	// ccc014animal xx = new ccc014animal();
	// import wo1261931780.stjavaSE.history.c2stage_20220113.ccc013brother_constructor.ccc024father;
