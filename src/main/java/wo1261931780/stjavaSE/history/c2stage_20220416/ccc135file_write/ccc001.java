...
public class ccc001 {
    public static void main(String[] args) throws IOException {
        ...
        Writer x = new FileWriter("src/c2stage_20220416/ccc135file_write/ddd050做数组拷贝.txt");
        x.write('x');
        ...
        // 在没有关闭的情况下，直接读取没有数据
        Reader x1 = new FileReader("src/c2stage_20220416/ccc135file_write/ddd050做数组拷贝.txt");
        int len;
        while ((len = x1.read()) != -1) {
