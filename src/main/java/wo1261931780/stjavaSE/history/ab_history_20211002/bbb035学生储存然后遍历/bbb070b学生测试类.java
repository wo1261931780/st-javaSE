...
public class bbb070b学生测试类 {
    public static void main(String[] args) {
        System.out.println("开始测试");
        // 这里，相当于我的集合，是在学生类中创建的
        ArrayList<bbb069a学生类> x = new ArrayList<>();
        // 下面添加的对象，也是针对学生类这个类进行的
        bbb069a学生类 x1 = new bbb069a学生类(11, "s1");
        bbb069a学生类 x2 = new bbb069a学生类(22, "s2");
        bbb069a学生类 x3 = new bbb069a学生类(33, "s3");
