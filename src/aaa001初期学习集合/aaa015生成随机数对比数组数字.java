...
public class aaa015生成随机数对比数组数字 {
    //    public static void main(String[] args){
//        System.out.println("xxxxxxxx终于来啦");
    public static void main(String[] args) {
        int[] arr = new int[12];//设定数组长度(元素个数12)
        System.out.println(Arrays.toString(arr));//[I@16b98e56这是地址
        //Arrays.toString(arr)把数组的地址转化成string类型的数组
        System.out.println(arr[0]);//这是里面的数值，因为是动态，所以是随机的。
